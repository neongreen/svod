...
authMap
  ...
  -> HandlerT App IO AuthResult -- ^ Verdict
authMap (AuthR _) _ = return Authorized
authMap FaviconR  _ = return Authorized
authMap RobotsR   _ = return Authorized
...
instance YesodAuth App where
  ...
  authenticate creds = runDB $ do
    user <- S.getUserByEmail (credsIdent creds)
    return $ case user of
